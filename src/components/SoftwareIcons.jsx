...
const SoftwareIcons = () => {
    return (
        <div className="border border-white bg-linear-to-br from-blue-darkest to-blue-light from-15% to-90% rounded-lg sm:w-lg py-10 flex flex-col items-center my-4">
            <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
